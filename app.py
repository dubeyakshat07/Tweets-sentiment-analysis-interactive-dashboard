...
st.title("Sentiment Analysis of Tweets about US")
st.sidebar.title("Sentiment Analysis of Tweets")

st.markdown("This application is a dashboard is for sentiment analysis of tweets built using streamlit")
...
hour=st.sidebar.slider("Hour of days",0,23)
...
choice=st.sidebar.multiselect("Pick the airline",('US Airways','United','American','Southwest','Delta'),key='0')
if len(choice)>0:
...
word_sentiment=st.sidebar.radio('Display word clouds',('positive','neutral','negative'))
